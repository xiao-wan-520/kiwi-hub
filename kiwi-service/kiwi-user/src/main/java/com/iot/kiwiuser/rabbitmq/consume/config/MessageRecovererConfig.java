...
public class MessageRecovererConfig {
    ...
    public Exchange errorMessageExchange() {
        return ExchangeBuilder
                .directExchange(RabbitConstant.USER_RECOVERY_EXCHANGE)
                .durable(true)
                .build();
    }
    ...
    public Queue errorQueue() {
        return QueueBuilder
                .durable(RabbitConstant.USER_RECOVERY_QUEUE)
                .build();
    }
    ...
    public Binding errorBinding(Exchange errorExchange, Queue errorQueue) {
        return BindingBuilder.bind(errorQueue)
                .to(errorExchange)
                .with(RabbitConstant.USER_RECOVERY_ROUTING_KEY)
                .noargs();
    }
    ...
    public MessageRecoverer republishMessageRecoverer(RabbitTemplate rabbitTemplate) {
        ...
        return new RepublishMessageRecoverer(rabbitTemplate,
                RabbitConstant.USER_RECOVERY_EXCHANGE,
                RabbitConstant.USER_RECOVERY_ROUTING_KEY);
    }
}
